...
export const sq = {
  ...
  quantityM2: "Sasia (m²)",
  quantityM2Optional: "Ose sasia në m² (opsionale)",
  fullPallets: "Paleta të plota",
  extraBoxes: "Kuti shtesë",
  looseTiles: "Pllaka të lira",
  location: "Vendndodhja në depo",
  save: "Ruaj",
  scanHint: "Skano kodin e lotit — pastaj paletat / kutitë",
